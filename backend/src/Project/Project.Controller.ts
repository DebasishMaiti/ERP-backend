...
export const getPlanedProjectsController = async (req: Request, res: Response) => {
  try {
    const result = await getPlanedProject();
    res.status(200).json(result);
  } catch (error) {
    res.status(500).json({ message: "Error retrieving projects", error });
  }
};
export const getInprogressProjectsController = async (req: Request, res: Response) => {
  try {
    const result = await getInProgressProject();
    res.status(200).json(result);
  } catch (error) {
    res.status(500).json({ message: "Error retrieving projects", error });
  }
};
export const getOnholdProjectsController = async (req: Request, res: Response) => {
  try {
    const result = await getOnHoldProject();
    res.status(200).json(result);
  } catch (error) {
    res.status(500).json({ message: "Error retrieving projects", error });
  }
};
export const getCompletedProjectsController = async (req: Request, res: Response) => {
  try {
    const result = await getCompletedProject();
    res.status(200).json(result);
  } catch (error) {
    res.status(500).json({ message: "Error retrieving projects", error });
  }

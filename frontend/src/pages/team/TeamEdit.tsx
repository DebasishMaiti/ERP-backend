...
import { ArrowLeft, RotateCcw, Power, PowerOff, Mail, Loader2 } from "lucide-react";
...
export default function TeamEdit() {
  ...
  useEffect(() => {
    const fetchTeam = async () => {
      try {
        ...
        if (memberId) {
          const member = res.data.find(m => m.teamId === memberId);
  ...
  const [permissions, setPermissions] = useState<Permissions>({
    ...
    permissions: {
      indent: {
        list: { read: false, write: false },
        create: { read: false, write: false },
        compare: { read: false, write: false },
        approval: { read: false, write: false },
      },
      purchaseOrders: {
        list: { read: false, write: false },
        open: { read: false, write: false },
      },
      items: {
        list: { read: false, write: false },
        addItem: { read: false, write: false },
      },
      vendors: {
        list: { read: false, write: false },
        create: { read: false, write: false },
      ...
      teamAndProject: {
        teamList: { read: false, write: false },
        addMember: { read: false, write: false },
        projectList: { read: false, write: false },
        addProject: { read: false, write: false },
        boqList: { read: false, write: false },
        addBoq: { read: false, write: false },
      },
    },
  });
  ...
  // Update form values when existingMember is loaded
  useEffect(() => {
    if (existingMember) {
      form.reset({
      ...
      if (existingMember.permissions) {
        setPermissions({
          projects: existingMember.permissions.projects || [],
          permissions: {
            indent: {
              list: existingMember.permissions.modules?.["indent-list"] || { read: false, write: false },
              create: existingMember.permissions.modules?.["indent-create"] || { read: false, write: false },
              compare: existingMember.permissions.modules?.["indent-compare"] || { read: false, write: false },
              approval: existingMember.permissions.modules?.["indent-approval"] || { read: false, write: false },
            },
            purchaseOrders: {
              list: existingMember.permissions.modules?.["po-list"] || { read: false, write: false },
              open: existingMember.permissions.modules?.["po-open"] || { read: false, write: false },
            },
            items: {
              list: existingMember.permissions.modules?.["items-list"] || { read: false, write: false },
              addItem: existingMember.permissions.modules?.["items-add"] || { read: false, write: false },
            },
            vendors: {
              list: existingMember.permissions.modules?.["vendors-list"] || { read: false, write: false },
              create: existingMember.permissions.modules?.["vendors-create"] || { read: false, write: false },
              accounts: existingMember.permissions.modules?.["vendors-accounts"] || { read: false, write: false },
            },
            teamAndProject: {
              teamList: existingMember.permissions.modules?.["team-list"] || { read: false, write: false },
              addMember: existingMember.permissions.modules?.["team-add"] || { read: false, write: false },
              projectList: existingMember.permissions.modules?.["project-list"] || { read: false, write: false },
              addProject: existingMember.permissions.modules?.["project-add"] || { read: false, write: false },
              boqList: existingMember.permissions.modules?.["boq-list"] || { read: false, write: false },
              addBoq: existingMember.permissions.modules?.["boq-add"] || { read: false, write: false },
            },
          },
        });
      }
  ...
  const getRoleDescription = () => {
    ...
    const moduleCount = Object.values(permissions.permissions)
      .flatMap(module => Object.values(module))
      .filter(m => m.read || m.write).length;
  ...
  if (memberId && !isLoading && !existingMember) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => navigate("/team/list")}>
            Back to Team List
          </Button>
        </div>
      </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>Used as login username</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                                ...
                                <AlertDialogContent>
                                  <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                      {currentStatus === "active" 
                                        ? "User will lose access to the system. Continue?" 
                                        : "User will regain access to the system. Continue?"}
                                    </AlertDialogDescription>
                                  </AlertDialogHeader>
                                  <AlertDialogFooter>
